...
- **Deceptive "Fake Remote" Warnings**: Analyzes job description text for hidden hybrid clauses (e.g., _"Must reside within 30 miles of office for mandatory weekly hybrid sync"_).
